      ...
      <div class="lg:w-1/2 flex flex-col justify-center space-y-6">
        ...
        <div class="pt-6">
          ...
          <button 
            ...
            class="w-full lg:w-auto bg-[#6366f1] hover:bg-indigo-600 text-white font-bold py-4 px-12 rounded-2xl transition-all shadow-xl shadow-indigo-100 active:scale-95 disabled:bg-gray-200 disabled:shadow-none disabled:text-gray-400 disabled:cursor-not-allowed"
